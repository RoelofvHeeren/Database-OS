    ...
    async function handleCreate(e: React.FormEvent) {
        ...
        try {
            const res = await fetch('/api/connections', {
                ...
                body: JSON.stringify({ name: newName, connectionUrl: newUrl }),
            });
            ...
            {showModal && (
                <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center p-4 z-50 animate-in fade-in duration-200">
                    <div className="bg-[#111111] border border-gray-800 rounded-2xl p-6 max-w-md w-full shadow-2xl relative overflow-hidden">
                        ...
                        <h3 className="text-xl font-bold text-white mb-1">Connect Database</h3>
                        <p className="text-sm text-gray-400 mb-6">Enter your credentials to start auditing.</p>
                        ...
                        <form onSubmit={handleCreate} className="space-y-4">
                            ...
                            <div className="flex gap-3 mt-8">
                                ...
                                >
                                    {isCreating ? <Loader2 className="w-4 h-4 animate-spin" /> : 'Connect'}
                                </button>
                            </div>
                        </form>
                    </div>
